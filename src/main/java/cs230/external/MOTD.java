...
/**
 * Class that handles returning the Message of the day.
 *
...
public class MOTD {
     ...
     */
    private static final int MIN_SUCCESSFUL_CODE = 200;

    /**
     * Maximum value for successful response codes.
     */
    private static final int MAX_SUCCESSFUL_CODE = 299;
    ...
    private String getRequest(final URL url) throws IOException {
        ...
        if (MIN_SUCCESSFUL_CODE <= conn.getResponseCode()
                && conn.getResponseCode() <= MAX_SUCCESSFUL_CODE) {
